...
function Logo () {
  return <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-10 h-10 text-white p-2 bg-indigo-500 rounded-full" viewBox="0 0 24 24">
...
function Footer () {
  return <footer>
    <div className="container">
      ...
      <p className="copyright">© 2020 AgencyHQ
      </p>
      <span className="social">
        <a className="social_button">
    ...
    <style jsx>{`
      ...
      footer .container {
        @apply px-5 py-8 mx-auto flex items-center flex-col
      }
      ...
      footer .logo {
        @apply flex font-medium items-center justify-center text-gray-900
      }
      ...
      @screen sm {
        footer .copyright {
          @apply ml-4 pl-4 border-l-2 border-gray-200 py-2 mt-0
        }
      }

      footer .social {
        @apply inline-flex mt-4 justify-center
      }

      @screen sm {
        footer .social {
          @apply ml-auto mt-0 justify-start
        }
      }
